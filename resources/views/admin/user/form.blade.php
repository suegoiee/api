 <ul class="nav nav-tabs" role="tablist">
    ...
    <li role="presentation" class="nav-item"><a class="nav-link" href="#forum_permission_tab" aria-controls="product" role="tab" data-toggle="tab">{{trans($module_name.'.admin.forum_category_tab')}}</a></li>
</ul>
<div class="tab-content py-3">
    ...
    <div role="tabpanel" class="tab-pane fade show" id="forum_permission_tab">
    	@include('admin.user.forum_permission_form')
    </div>
</div>