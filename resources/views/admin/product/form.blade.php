 <ul class="nav nav-tabs" role="tablist">
    ...
    <li role="presentation" id="single_option_tab" class="nav-item {{ $data && $data->category!= 1 ? 'hide':''}}"><a class="nav-link" href="#single_option_content" aria-controls="faq" role="tab" data-toggle="tab">{{trans($module_name.'.admin.single_option_tab')}}</a></li>
</ul>
