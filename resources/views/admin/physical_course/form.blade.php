<ul class="nav nav-tabs" role="tablist">
    ...
    <li role="presentation" class="nav-item"><a class="nav-link" href="#plan_tab" aria-controls="plan" role="tab" data-toggle="tab">{{trans($module_name.'.admin.plan_tab')}}</a></li>
...
<div class="tab-content py-3">
    ...
    <div role="tabpanel" class="tab-pane fade" id="plan_tab">
        @include('admin.physical_course.plan_form')
    </div>
